...
#----------------------------------------------------------------------------------------------
    def fetchService(self, i_idService):
        get_service_query = "SELECT * FROM Service WHERE Service.idService = %s;"
...
#----------------------------------------------------------------------------------------------
    def fetchLocation(self, i_idLocation):
        get_location_query = "SELECT * FROM Location WHERE Location.idLocation = %s;"
...
#----------------------------------------------------------------------------------------------
    def fetchLegalEntity(self, i_idLegalEntity):
        get_legalentity_query = "SELECT * FROM LegalEntity WHERE LegalEntity.idLegalEntity = %s;"
